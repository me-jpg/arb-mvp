...
### Example: pure_arb Signal

Generated when the HF arbitrage engine finds a profitable 2-way arb.

```json
{
  "id": "pure_arb_2025-12-04_Dallas_Cowboys_vs_Detroit_Lions_draftkings_betmgm_1733340000000",
  "createdAt": "2025-12-04T21:33:20.000Z",
  "type": "pure_arb",
  "eventId": "2025-12-04_Dallas_Cowboys_vs_Detroit_Lions",
  "marketType": "moneyline",
  "side": "home",
  ...
  "confidence": 0.9,
  "metadata": {
    "arbId": "2025-12-04_Dallas_Cowboys_vs_Detroit_Lions",
    "cycleId": "hf-1733340000000",
    "comboBooks": ["draftkings", "betmgm"],
    "totalImplied": 0.976,
    "impliedHold": 0.024,
    "totalStake": 1000,
    "stakePrimary": 520.25,
    "stakeSecondary": 479.75,
    "guaranteedProfit": 24.00,
    "guaranteedReturn": 1024.00,
    "selections": [
      { "outcome": "home", "book": "draftkings", "price": -110 },
      { "outcome": "away", "book": "betmgm", "price": +120 }
    ]
  }
}
```

**Persistence:** Signals are appended to `logs/signals.jsonl`:
- `stale_vs_book` signals: generated by `npm run signals:analyze` from stale line data.
- `pure_arb` signals: generated automatically by the HF tracker when arb opportunities are found.

Each persisted entry includes an additional `persistedAt` timestamp.
