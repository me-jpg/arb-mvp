...
// Test 1: Basic stale line detection
{
  const changes = [
    ...
    { event_id: 'EVT1', book: 'draftkings', market_type: 'moneyline', side: 'home', detected_at: new Date(8000) }
  ];
...
// Test 2: No stale lines when all books move within threshold
{
  const changes = [
    ...
    { event_id: 'EVT1', book: 'espnbet', market_type: 'moneyline', side: 'home', detected_at: new Date(2000) }
  ];
...
// Test 3: Multiple stale books
{
  const changes = [
    ...
    { event_id: 'EVT1', book: 'betmgm', market_type: 'moneyline', side: 'home', detected_at: new Date(1000) },
    { event_id: 'EVT1', book: 'espnbet', market_type: 'moneyline', side: 'home', detected_at: new Date(2000) },
    { event_id: 'EVT1', book: 'draftkings', market_type: 'moneyline', side: 'home', detected_at: new Date(10000) }
  ];
...
// Test 4: Different markets tracked separately
{
  const changes = [
    ...
    { event_id: 'EVT1', book: 'draftkings', market_type: 'spread', side: 'home', detected_at: new Date(0) },
    { event_id: 'EVT1', book: 'betmgm', market_type: 'spread', side: 'home', detected_at: new Date(1000) }
  ];
...
// Test 5: Different events tracked separately
{
  const changes = [
    ...
    { event_id: 'EVT2', book: 'draftkings', market_type: 'moneyline', side: 'home', detected_at: new Date(0) },
    { event_id: 'EVT2', book: 'betmgm', market_type: 'moneyline', side: 'home', detected_at: new Date(2000) }
  ];
...
// Test 6: Stale lines sorted by duration (longest first)
{
  const changes = [
    { event_id: 'EVT1', book: 'draftkings', market_type: 'moneyline', side: 'home', detected_at: new Date(0) },
    { event_id: 'EVT1', book: 'betmgm', market_type: 'moneyline', side: 'home', detected_at: new Date(3000) },
    { event_id: 'EVT1', book: 'espnbet', market_type: 'moneyline', side: 'home', detected_at: new Date(1000) },
